...
import pandas as pd
from svgpathtools import parse_path, wsvg ## TODO: add pip-installed packages to the pythonpath that conda looks at
    ...
    if type(strokes)==pd.core.frame.DataFrame:
        for i,d in strokes.iterrows():
            try:
                ...
                stroke_coords  = d['currentRawLineSimplified']
